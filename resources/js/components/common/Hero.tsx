 ...
 return (
  <>
   <div className=" flex sm:-mt-16 px-4  sm:flex-row tab:mt-32 tab:flex-col-reverse flex-col-reverse items-center relative   justify-between h-screen w-full sm:mb-10     ">
    ...
    <div className=" sm:w-1/2 w-full tab:w-full  tab:mb-20 mb-8 sm:mb-0 sm:border-cta  rounded-3xl tab:rounded-3-xl tab:border-2 border-8 tab:mr-0 tab:px-8  sm:mr-12 ">
     <img
      src={
