    ...
    return (
        <div className=" bg-cta">
            <div className=" sm:px-32 flex flex-col">
                ...
                <p className=" text-white text-base mb-12">
                    Make faster and more informed data-driven decisions, stay on
                    top of your project, and keep all stakeholders informed
                    while reducing surprises, delays, cost overruns, and claims.
                </p>
